export default function Home() {
  return (
    <>
      ...
      {/* Nav */}
      <nav className="fixed top-0 left-0 w-full z-50 px-6 py-5 flex justify-between items-center border-b border-white/5 bg-[#01080a]/40 backdrop-blur-md">
        ...
        <div className="hidden lg:flex items-center gap-12 font-mono text-[10px] tracking-[0.3em]">
          ...
          <a className="hover:text-[#EE6352] transition-colors text-white border-b border-white/20 pb-1" href="#deploy">[ GET STARTED ]</a>
        </div>
      ...
      <main className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center relative px-6 py-32 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none opacity-40">
            ...
            <div className="absolute top-1/4 left-10 font-mono text-[10px] text-slate-600 flex flex-col gap-1">
              <span>LNG: -118.2437</span>
              <span>LAT: 34.0522</span>
              <div className="w-20 h-px bg-white/10 mt-2" />
            </div>

            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-bold text-[25vw] text-white/[0.02] select-none tracking-tighter uppercase whitespace-nowrap">
              DISPATCH
            </div>
          </div>
          ...
          <div className="max-w-7xl w-full text-center relative z-20">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[7rem] font-bold text-white leading-[0.9] tracking-tighter mb-12 uppercase italic text-glow">
            ...
            <div className="flex flex-col items-center max-w-3xl mx-auto">
              <p className="text-slate-400 font-light leading-relaxed mb-12 tracking-wide uppercase font-mono text-[14px]">
              ...
              <div className="flex flex-col sm:flex-row gap-8 items-center">
                ...
                <a href="https://my.tow-x.com" className="group relative px-12 py-5 border border-white/20 text-white overflow-hidden transition-all hover:border-[#EE6352]/50">
        ...
        {/* Marquee ticker */}
        <div className="border-y border-white/5 bg-white/[0.02] py-6 overflow-hidden flex items-center whitespace-nowrap">
          <div className="flex gap-20 animate-marquee font-mono text-[10px] tracking-[0.5em] text-white/20 uppercase italic">
            <span>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
              <div className="max-w-xl">
                ...
                <h2 className="text-4xl lg:text-6xl font-bold text-white tracking-tighter">MAXIMIZE FLEET EFFICIENCY.</h2>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1" id="features">
              {[
                ...
                <div
                  key={card.mod}
                  className="group relative bg-white/[0.02] border border-white/5 p-8 transition-all hover:bg-white/[0.04] hover:border-white/10"
                >
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed mb-6 font-light">{card.desc}</p>
                  <div className="font-mono text-[9px] text-white/30 flex justify-between">
                    <span>{card.mod}</span>
        ...
        {/* Workflow */}
        <section className="py-32 bg-black/40" id="workflow">
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-24">
              <div className="font-mono text-[#00d4ff] text-[10px] mb-4 tracking-[0.4em]">DISPATCH WORKFLOW</div>
              <h2 className="text-4xl lg:text-5xl font-bold text-white tracking-tighter">OPERATIONAL LIFECYCLE.</h2>
            </div>
            ...
            <div className="space-y-12 relative">
              ...
              <div className="relative flex flex-col md:flex-row items-start md:items-center gap-12 group">
                <div className="w-full md:w-1/2 md:text-right">
                  <h4 className="font-mono text-lg text-white mb-2 uppercase tracking-tighter">01. Job Intake</h4>
                  <p className="text-sm text-slate-500 max-w-sm md:ml-auto">
                ...
                <div className="w-full md:w-1/2 pl-12 md:pl-0">
                  <div className="inline-block bg-white/5 border border-white/10 p-2 font-mono text-[9px] text-[#EE6352]">
                    [ PENDING JOB ]
                  </div>
                </div>
              </div>
              ...
              <div className="relative flex flex-col md:flex-row-reverse items-start md:items-center gap-12 group">
                <div className="w-full md:w-1/2">
                  <h4 className="font-mono text-lg text-white mb-2 uppercase tracking-tighter">02. Fleet Routing</h4>
                ...
                <div className="w-full md:w-1/2 pr-12 md:pr-0 md:text-right">
                  <div className="inline-block bg-white/5 border border-white/10 p-2 font-mono text-[9px] text-[#00d4ff]">
                    [ UNIT EN ROUTE ]
                  </div>
                </div>
              </div>
              ...
              <div className="relative flex flex-col md:flex-row items-start md:items-center gap-12 group">
                <div className="w-full md:w-1/2 md:text-right">
                  <h4 className="font-mono text-lg text-white mb-2 uppercase tracking-tighter">03. Job Completion</h4>
                  <p className="text-sm text-slate-500 max-w-sm md:ml-auto">
                ...
                <div className="w-full md:w-1/2 pl-12 md:pl-0">
                  <div className="inline-block bg-white/5 border border-white/10 p-2 font-mono text-[9px] text-green-500">
                    [ JOB FINALIZED ]
                  </div>
                </div>
              </div>
        ...
        <section className="py-32 px-6 relative overflow-hidden" id="deploy">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 border border-white/5 bg-slate-900/40 backdrop-blur-3xl p-12 lg:p-24">
            <div className="font-mono text-[#EE6352] text-[10px] mb-10 tracking-[1em]">Free Trial</div>
            <h2 className="text-5xl lg:text-7xl font-bold text-white tracking-tighter mb-8 leading-none">
            ...
            <div className="flex flex-col items-center gap-6">
              <a href="https://my.tow-x.com" className="relative group px-12 py-6 bg-white text-black font-bold font-mono tracking-[0.4em] transition-all hover:bg-[#EE6352] hover:text-white">
                Get a DEMO
                <div className="absolute -inset-2 border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity" />
              </a>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-black py-20 px-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-20">
            <div className="lg:col-span-2">
              <div className="flex flex-col gap-2 mb-8">
                <span className="text-xl font-bold text-white tracking-tighter uppercase">Towix Dispatch Pro</span>
                <span className="font-mono text-[10px] text-[#EE6352] tracking-[0.5em]">FLEET DOMINANCE</span>
              </div>
              <p className="text-xs text-slate-600 max-w-sm font-mono leading-relaxed uppercase">
            ...
            <div>
              <h5 className="text-white/60 font-mono text-[10px] tracking-widest mb-8 uppercase">PLATFORM</h5>
              <ul className="space-y-4 font-mono text-[10px] text-slate-500 tracking-widest">
            ...
            <div>
              <h5 className="text-white/60 font-mono text-[10px] tracking-widest mb-8 uppercase">LEGAL</h5>
              <ul className="space-y-4 font-mono text-[10px] text-slate-500 tracking-widest">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-12 border-t border-white/5 font-mono text-[9px] text-slate-700 tracking-[0.3em]">
            <div>© 2024 TOWIX_CORP. ALL_RIGHTS_RESERVED.</div>
            <div className="flex gap-8">
              <a className="hover:text-white transition-colors" href="#">LINKED_IN</a>
              <a className="hover:text-white transition-colors" href="#">TERMINAL_X</a>
              <a className="hover:text-white transition-colors" href="#">SIGNAL_COMM</a>
            </div>
